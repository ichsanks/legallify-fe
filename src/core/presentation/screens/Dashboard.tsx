              ...
              <Row>
                ...
                <Col xs="9">
                  <div className="numbers">
                    <p className="card-category">Overdue</p>
          ...
          <Card className="card-stats">
            <Card.Body>
              <Row>
                ...
                <Col xs="9">
                  <div className="numbers">
                    <p className="card-category">Upcoming</p>
          ...
          <Card className="card-stats">
            <Card.Body>
              <Row>
                ...
                <Col xs="7">
                  <div className="numbers">
                    <p className="card-category">On Process</p>
            ...
            <Card.Footer>
              <hr></hr>
              <div className="stats">
                <i className="far fa-clock-o mr-1"></i>2 Waiting for approval
              </div>
            </Card.Footer>
          </Card>
        </Col>
          ...
          <Card className="card-stats">
            <Card.Body>
              <Row>
                ...
                <Col xs="7">
                  <div className="numbers">
                    <p className="card-category">Compliant</p>
